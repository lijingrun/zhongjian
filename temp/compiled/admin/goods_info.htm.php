...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      <p>
		...
		<span class="tab-back" id="user-tab"><?php echo $this->_var['lang']['tab_user']; ?></span>
      </p>
    </div>
...
<!--
     卧夕阳工作室 by http://www.51shopla.com	
	 QQ:1986219154
	 star
-->	
	  <!-- 限制会员列表 -->
        <table width="90%" id="user-table" style="display:none" align="center">
          ...
          <tr>
            <td colspan="3">
              <img src="images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
              <?php echo $this->_var['lang']['user_title']; ?> <input type="text" name="user_name" />
              <input type="button" value="<?php echo $this->_var['lang']['button_search']; ?>" onclick="searchMember()" class="button" />
            </td>
          </tr>
          <!-- 会员列表 -->
          <tr>
            <th><?php echo $this->_var['lang']['all_user']; ?></th>
            <th><?php echo $this->_var['lang']['handler']; ?></th>
            <th><?php echo $this->_var['lang']['tab_user']; ?></th>
          </tr>
          <tr>
            <td width="45%">
              <select name="source_select4" size="20" style="width:100%" multiple ondblclick="sz4.addItem(false, 'add_goods_member', goodsId, this.form.elements['price2'].value)">
              </select>
            </td>
            <td align="center">
              <p><input type="button" value=">>" onclick="sz4.addItem(true, 'add_goods_member', goodsId, this.form.elements['price2'].value)" class="button" /></p>
              <p><input type="button" value=">" onclick="sz4.addItem(false, 'add_goods_member', goodsId, this.form.elements['price2'].value)" class="button" /></p>
              <p><input type="button" value="<" onclick="sz4.dropItem(false, 'drop_goods_member', goodsId, elements['is_single'][0].checked)" class="button" /></p>
              <p><input type="button" value="<<" onclick="sz4.dropItem(true, 'drop_goods_member', goodsId, elements['is_single'][0].checked)" class="button" /></p>
            </td>
            <td width="45%">
              <select name="target_select4" size="20" style="width:100%" multiple ondblclick="sz4.dropItem(false, 'drop_goods_member', goodsId, elements['is_single'][0].checked)">
                <?php $_from = $this->_var['goods_member_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_member');if (count($_from)):
    foreach ($_from AS $this->_var['goods_member']):
?>
                <option value="<?php echo $this->_var['goods_member']['user_id']; ?>"><?php echo $this->_var['goods_member']['user_name']; ?></option>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              </select>
            </td>
          </tr>
...
<script language="JavaScript">
  ...
  var sz4 = new SelectZone(1, elements['source_select4'], elements['target_select4']);//卧夕阳工作室  QQ:1986219154
...
?>
  ...
  /**
   卧夕阳工作室 by http://www.51shopla.com   开始
   QQ:1986219154
   * 关联会员函数
   */
  function searchMember()
  {
    ...
    sz4.loadOptions('get_member_list', filters);
  }
